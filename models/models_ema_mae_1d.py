...
class EMAMaskedAutoencoderViT1d(nn.Module):
...
def ema_mae_1d_large_8_1024(**kwargs):
    model = EMAMaskedAutoencoderViT1d(
        embed_dim=1024, depth=8, num_heads=16,
        decoder_embed_dim=1024, decoder_depth=8, decoder_num_heads=16, 
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model

def ema_mae_1d_base_6_768(**kwargs):
    model = EMAMaskedAutoencoderViT1d(
...
def ema_mae_1d_small_4_768(**kwargs):
    model = EMAMaskedAutoencoderViT1d(
...
def ema_vit_1d_large_8_1024(**kwargs):
    model = EMAMaskedAutoencoderViT1d(
        embed_dim=1024, depth=8, num_heads=16,
        decoder_embed_dim=1024, decoder_depth=8, decoder_num_heads=16,
...
def ema_vit_1d_base_6_768(**kwargs):
    model = EMAMaskedAutoencoderViT1d(
        embed_dim=768, depth=6, num_heads=12,
        decoder_embed_dim=768, decoder_depth=6, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), mae=False, **kwargs)
...
def ema_vit_1d_small_4_768(**kwargs):
    model = EMAMaskedAutoencoderViT1d(
        embed_dim=768, depth=4, num_heads=12,
        decoder_embed_dim=768, decoder_depth=4, decoder_num_heads=12,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), mae=False, **kwargs)
...
ema_mae1d_large = ema_mae_1d_large_8_1024
ema_mae1d_base = ema_mae_1d_base_6_768
ema_mae1d_small =  ema_mae_1d_small_4_768
ema_vit1d_large = ema_vit_1d_large_8_1024
ema_vit1d_base = ema_vit_1d_base_6_768
ema_vit1d_small =  ema_vit_1d_small_4_768